...
class Controller:
    ...
    def create(self, mandate: dict) -> dict:
        ...
        prompt_version = "v2" if is_m2(mandate) else PROMPT_VERSION
        ...
        with self.store.lock():
            ...
            if is_m2(mandate):
                state['runtime_policy_version'] = 'investment-research-m2-v1'
    ...
    def execute_task(self, state, task):
        ...
        while task["status"] == "RUNNING":
            ...
            if is_m2(state['mandate']):
                request['context']['market_context'] = state['market_context']
