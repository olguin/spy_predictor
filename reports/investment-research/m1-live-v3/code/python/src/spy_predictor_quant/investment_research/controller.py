    ...
    def create(self, mandate: dict) -> dict:
        ...
        with self.store.lock():
            ...
            state = {"schema_version": "investment-research-run-v1", "run_id": str(uuid.uuid4()),
                ...
                "runtime_policy_version": "investment-research-m1-v3", "followup_round": 0,
    ...
    def execute_task(self, state, task):
        ...
        while task["status"] == "RUNNING":
            ...
            request = {"schema_version": WORKER_PROTOCOL, "task_id": task["task_id"],
                ...
                "tool_schemas": tool_schemas(json.loads((ROOT / f"prompts/investment-research/{PROMPT_VERSION}/tools.json").read_text()), task, state, remaining_turns)}
